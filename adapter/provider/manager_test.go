...
func (p *closeErrorProvider) Outbound(tag string) (adapter.Outbound, bool) {
	return nil, false
}
...
func (p *closeErrorProvider) HealthCheck(ctx context.Context) (map[string]uint16, error) {
	return nil, nil
}

func (p *closeErrorProvider) RegisterCallback(callback adapter.ProviderUpdateCallback) *list.Element[adapter.ProviderUpdateCallback] {
	return nil
}

func (p *closeErrorProvider) UnregisterCallback(element *list.Element[adapter.ProviderUpdateCallback]) {
}
