...
Names are trimmed, converted to lowercase and deduplicated. The first name is the primary storage key. Keep it first when adding domains; an existing certificate that does not cover the updated list is renewed during startup.
