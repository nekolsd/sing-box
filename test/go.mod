...
replace (
	...
	github.com/sagernet/sing => github.com/nekolsd/sing v0.8.11-nekolsd
	github.com/sagernet/sing-tun => github.com/nekolsd/sing-tun v0.8.11-nekolsd
)
...
require (
	...
	github.com/reF1nd/sing-snell v0.0.7 // indirect
